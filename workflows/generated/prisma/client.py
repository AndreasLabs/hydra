...
SCHEMA_PATH = Path('/Users/alex/repos/andreas/hydra/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/alex/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(SyncBasePrisma):
    ...
    dataasset: 'actions.DataAssetActions[models.DataAsset]'
    ...
    def __init__(
        ...
        *,
        ...
        self.dataasset = actions.DataAssetActions[models.DataAsset](self, models.DataAsset)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/alex/repos/andreas/hydra/prisma/schema.prisma',
        }
...
class Batch:
    dataasset: 'DataAssetBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.dataasset = DataAssetBatchActions(self)
